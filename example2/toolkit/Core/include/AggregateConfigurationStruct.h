...
#ifndef _AggregateConfigurationStruct_H_
#define _AggregateConfigurationStruct_H_
...
//lint -sem(AggregateConfigurationStruct::clear, initializer)
typedef struct AggregateConfigurationStruct
{
