...
//lint -sem(SimpleAttributeOperandStruct::clear, initializer)
typedef struct SimpleAttributeOperandStruct
{
	...
	* If this list is empty the Node is the instance of the TypeDefinition. */
	unsigned browsePath_count;
	QualifiedNameStruct* browsePath;
	...
	* All values in the array are used if this parameter is not specified. */
	...
	EnumStatusCode setBrowsePath(unsigned BrowsePathCount, const QualifiedNameStruct* BrowsePath);
