 ...
 */
static const TCHAR OT_DEFAULT_LOCALE[] = _T("");
...
//lint -sem(LocalizedTextStruct::clear, initializer)
typedef struct LocalizedTextStruct
{
	/*!
	...
	LocalizedTextStruct(const TCHAR* translation);
	 ...
	 */
	EnumStatusCode getTranslation_API(unsigned preferredLocalesCount, const TCHAR** pPreferredLocales, tstring& translation, tstring& locale) const;
