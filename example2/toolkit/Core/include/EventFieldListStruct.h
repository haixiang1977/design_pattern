...
//lint -sem(EventFieldListStruct::clear, initializer)
typedef struct EventFieldListStruct
{
	unsigned eventFields_count;
	ValueStruct* eventFields;


#ifdef OT_COMPILATION
	EventFieldListStruct();
	EnumStatusCode setEventFields(unsigned EventFieldsCount, const ValueStruct* EventFields);
