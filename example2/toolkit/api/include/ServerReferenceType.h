...
namespace SoftingOPCToolbox5
{
	namespace Server
	{
		...
		*
		* The Toolkit defines constants for all well-known reference types in the Statics namespace (e.g. Statics::ReferenceTypeId_Organizes). */
		...
		public:
			...
			/*! @deprecated		Please use ReferenceType::create() to construct an instance of this type.
