...
namespace SoftingOPCToolbox5
{
	...
	* accomplished using the BrowseNext service. */
	...
	public:
		...
		/* see IBrowseResult::setStatusCode */
		DEPRECATED(virtual void setStatusCode(EnumStatusCode value));

		/* see IBrowseResult::getContinuationPoint */
		virtual ByteString getContinuationPoint() const;
		/* see IBrowseResult::setContinuationPoint */
		DEPRECATED(virtual void setContinuationPoint(const ByteString& value));
		...
		/* see IBrowseResult::addReference */
		DEPRECATED(virtual EnumStatusCode addReference(const IReferenceDescription* value));
