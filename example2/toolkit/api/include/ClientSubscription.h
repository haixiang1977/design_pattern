...
namespace SoftingOPCToolbox5
{
	...
	namespace Client
	{
		...
		*
		* @note	Please note that publishing of data changes and/or events is off by default
		*		and needs to be enabled by setPublishingEnabled(true).
		*
		* @see MonitoredItem */
		...
		public:
			...
			/*! @deprecated		Please use Subscription::create() to construct an instance of this type.
		...
		public:
			...
			*
			* @note The default value is the invalid value 0.
			...
			*
			* This parameter can only be set before connecting a Subscription (see connect()).
			* You may use disablePublishing() or enablePublishing() to disable or enable
			* publishing after a Subscription has been connected. This attribute will be updated
			* accordingly.
			*
			* @note		Publishing is disabled by default.
			* @note		Please use enablePublishing() or disablePublishing() instead of this method
			*			if the Subscription is already connected. */
			...
			* @see connect() */
			...
			/*! @deprecated Use addMonitoredItems(const std::vector<Client::MonitoredItemPtr>) instead.
			* @overload */
			DEPRECATED(EnumStatusCode addMonitoredItems(const std::vector<Client::MonitoredItem*>& items));
			...
			* @param items The MonitoredItem to remove from the Subscription */
			...
			/*! @deprecated Use removeMonitoredItems(const std::vector<Client::MonitoredItemPtr>&) instead.
			* @overload */
			DEPRECATED(EnumStatusCode removeMonitoredItems(const std::vector<Client::MonitoredItem*>& items));
			...
			* @param items The list of MonitoredItems that contain local modifications */
			...
			/*! @deprecated Use updateMonitoredItems(const std::vector<Client::MonitoredItemPtr>&) instead.
			* @overload */
			DEPRECATED(EnumStatusCode updateMonitoredItems(const std::vector<Client::MonitoredItem*>& items));
			...
			* @see setAllMonitoredItemsMonitoringMode() */
			...
			/*! @deprecated Use setMonitoredItemsMonitoringMode(const std::vector<Client::MonitoredItem*>&, EnumMonitoringMode) instead.
			* @overload */
			DEPRECATED(EnumStatusCode setMonitoredItemsMonitoringMode(const std::vector<Client::MonitoredItem*>& monitoredItems, EnumMonitoringMode eMonitoringMode));
