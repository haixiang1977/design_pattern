...
namespace SoftingOPCToolbox5
{
	...
	namespace Client
	{
		...
		*
		* @note	Please note that reporting of data changes or events is off by default
		*		and needs to be enabled by setMonitoringMode(EnumMonitoringMode_Reporting).
		*
		* @see Subscription */
		...
		public:
			...
			/*! @deprecated		Please use MonitoredItem::create() to construct an instance of this type.
		...
		public:
			...
			* @see removeItemsToReport() */
			...
			/*! @deprecated Use addItemsToReport(const std::vector<Client::MonitoredItemPtr>) instead.
			* @overload */
			DEPRECATED(EnumStatusCode addItemsToReport(const std::vector<Client::MonitoredItem*>& itemsToReport));
			...
			* @see addItemsToReport() */
			...
			/*! @deprecated Use removeItemsToReport(const std::vector<Client::MonitoredItemPtr>) instead.
			* @overload */
			DEPRECATED(EnumStatusCode removeItemsToReport(const std::vector<Client::MonitoredItem*>& itemsToReport));
