	...
	* to specify a node and its attribute to write. */
	...
	public:
		...
		* If this parameter is omitted, all elements of the array are included in the range. */
		...
		/*! @deprecated Please use getDataValue() instead */
		virtual const IDataValue* getValue() const = 0;
		/*! @deprecated Please use getDataValue() instead */
		virtual IDataValue* getValue() = 0;
		/*! @deprecated Please use setDataValue() instead */
		virtual void setValue(const IDataValue* value) = 0;
		/*! @deprecated Please use setDataValue() instead */
		virtual void setValue(const DataValue& value) = 0;
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IWriteValue& other) = 0;
