...
namespace SoftingOPCToolbox5
{
	...
	* to return a list of results for the list of provided browse paths (see BrowsePath). */
	...
	public:
		...
		virtual bool operator==(const IBrowsePathResult& other);
		...
		virtual unsigned getTargetCount() const;
		/* see IBrowsePathResult::getTarget */
		virtual const IBrowsePathTarget* getTarget(unsigned index) const;
