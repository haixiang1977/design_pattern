...
namespace SoftingOPCToolbox5
{
	namespace Server
	{
		...
		* The DiscreteItem class defines no additional properties. */
		...
		{
		public:
			/*! @deprecated This variable type is abstract and shall not be used. Use only derived concrete variable types instead. */
			DEPRECATED(static ObjectPointer<DiscreteItem> create());
