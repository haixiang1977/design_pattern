	...
	namespace Server
	{
		...
		* and AcknowledgeableConditionConfirm. */
		...
		public:
			...
			/*! @deprecated		Please use AcknowledgeableCondition::create() to construct an instance of this type.
		...
		public:
			...
			*				can be defined by TwoStateVariable::setTrueState() and TwoStateVariable::setFalseState(). */
			DEPRECATED(virtual EnumStatusCode setAckedState(const ILocalizedText* ackedState));
			/*! @overload */
			DEPRECATED(virtual EnumStatusCode setAckedState(const ILocalizedText& ackedState));
			...
			*				The localized texts that describe the 'true' and 'false' confirmation state
			*				can be defined by TwoStateVariable::setTrueState() and TwoStateVariable::setFalseState(). */
			DEPRECATED(virtual EnumStatusCode setConfirmedState(const ILocalizedText* confirmedState));
			/*! @overload */
			DEPRECATED(virtual EnumStatusCode setConfirmedState(const ILocalizedText& confirmedState));
