...
namespace SoftingOPCToolbox5
{
	...
	* @see IContentFilter IAttributeOperand */
	...
	public:
		...
		virtual bool operator==(const ISimpleAttributeOperand& other);
		...
		virtual unsigned getBrowsePathCount() const;
		/* see ISimpleAttributeOperand::getBrowsePath */
		virtual const IQualifiedName* getBrowsePath(unsigned index) const;
		/*! @overload */
		virtual std::vector<QualifiedName> getBrowsePath() const;
		/* see ISimpleAttributeOperand::addBrowsePath */
		virtual EnumStatusCode addBrowsePath(const IQualifiedName* value);
		/*! @overload */
