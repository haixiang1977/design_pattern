	...
	namespace Server
	{
		...
		* Variables are used to expose values in the address space of a server. */
		...
		public:
			...
			/*! @deprecated		Please use Variable::create() to construct an instance of this type.
		...
		public:
			...
			* @see AccessPattern and Application::getAccessPatterns() */
			...
			/*! Assigns the variable a previously defined AccessPattern. An AccessPattern defines
			* the users' rights to access the value of the variable.
			*
			...
			* @param request		The request to handle
			*
			* @note The StatusCode in the request is already preprocessed by the toolkit. @see Server::WriteTransaction::handleRequests.
			*
			* @note	When overriding this method you mustn't use blocking calls within this method since
			* this blocks the UA communication. */
			...
			* The Toolkit will automatically keep update property Value updated to the Variable's Value.
			*
