...
/*! Parses a node set XML file and imports the node set into the addresspace of the Softing OPC UA Toolkit.
*
...
MODELDESIGNER_EXPORT EnumModelDesignerStatus MODELDESIGNER_CALL MCNodeSet2ImportLoadNodeSetXmlFile(const TCHAR* xmlFilePath, 
