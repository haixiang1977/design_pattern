...
typedef enum tagEnumModelDesignerStatus
{
	...
	//! The number of imported nodes exceed allowed number without license
	EnumModelDesignerStatus_BadNodeImportExceedsDemoCount = 2,
...
MC_ERROR_REPORT_EXPORT const TCHAR* MC_ERROR_REPORT_CALL MCGetEnumModelDesignerStatusString(EnumModelDesignerStatus status);
/*! Returns a description of a status code */
MC_ERROR_REPORT_EXPORT const TCHAR* MC_ERROR_REPORT_CALL MCGetEnumModelDesignerStatusDescription(EnumModelDesignerStatus status);
...
MC_ERROR_REPORT_EXPORT const TCHAR* MC_ERROR_REPORT_CALL MCGetEnumMCErrorContextTypeString(EnumMCErrorContextType contextType);
...
TBC_EXPORT const TCHAR* getEnumModelDesignerStatusString(EnumModelDesignerStatus value);
