...
typedef void (MC_ERROR_REPORT_CALL *MCErrorCallback)(EnumTraceLevel severity, EnumTraceGroup group, EnumModelDesignerStatus error, const TCHAR* errorMessage, const MCErrorContext* errorContext);
...
/*! Reports an error with a related error context to all registered callbacks and to trace mechanism used by the Softing OPC UA Toolkit.
*
...
MC_ERROR_REPORT_EXPORT EnumModelDesignerStatus MC_ERROR_REPORT_CALL MCErrorReportReportError(EnumTraceLevel severity, EnumTraceGroup group, EnumModelDesignerStatus error, const TCHAR* errorMessage, const MCErrorContext* errorContext);

/*! This is a convenience method for MCErrorReportReportError used with an XML context */
MC_ERROR_REPORT_EXPORT EnumModelDesignerStatus MC_ERROR_REPORT_CALL MCErrorReportReportXMLError(EnumTraceLevel severity, EnumTraceGroup group, EnumModelDesignerStatus error, const TCHAR* errorMessage, const TCHAR* fileName, OTInt32 lineNumber);
