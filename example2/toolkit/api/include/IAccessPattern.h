...
namespace SoftingOPCToolbox5
{
	...
	*
	* The Toolkit uses a matrix to organize user access rights. The AccessPatterns represent the rows
	...
	* key to refer to an AccessPattern. The Toolkit defines a reserved default access pattern (key = 0) that
	...
	*
	* @note	Please note that the Toolkit defines a default AccessPattern with key "0" that uses
	...
	*		Server::Variable::setAccessPatternKey() Server::Method::setAccessPatternKey() */
	...
	public:
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IAccessPattern& other) = 0;
