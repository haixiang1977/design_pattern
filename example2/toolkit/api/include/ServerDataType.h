	...
	namespace Server
	{
		...
		* DataType nodes are used to define the data type of a variable. */
		...
		public:
			...
			/*! @deprecated		Please use DataType::create() to construct an instance of this type.
		...
		public:
			...
			* @param encodingNodeId				The NodeId used to identify values of this datatype. This parameter is
			*									ignored or Enumeration data types, since they are always encoded as Int32.
