	...
	namespace Server
	{
		...
		* @note The value of this variable type should not be changed manually */
		...
		public:
			...
			/*! Registers the stored data type dictionary, in order to be able to use all stored data type descriptions
