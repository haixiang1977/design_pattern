	...
	* accomplished using the BrowseNext service. */
	...
	public:
		...
		* @see Client::Session::browseNext() */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setContinuationPoint(const ByteString& value) = 0;
		...
		* Since each node can have more than one reference, an array of references is returned for each node. */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual EnumStatusCode addReference(const IReferenceDescription* value) = 0;
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IBrowseResult& other) = 0;
