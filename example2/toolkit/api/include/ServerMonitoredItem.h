	...
	namespace Server
	{
		...
		* an OPC UA client to monitor data changes or events. */
		...
		public:
			...
			/*! Returns the id of this monitored item. This identifier has been assigned by the Toolkit core. */
			...
			* The index range is provided for informational purposes only. The Toolkit
			...
			* change filter is provided for informational purposes only. The Toolkit applies
			...
			* filter is provided for informational purposes only. The Toolkit applies
			...
			* Triggering links are evaluated by the Toolkit automatically. */
			...
			* evaluated by the Toolkit automatically. */
		...
		private:
			...
			* MonitoredItem objects are created in Toolkit core only when a client creates them via service. */
			MonitoredItem();
