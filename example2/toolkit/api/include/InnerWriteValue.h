...
namespace SoftingOPCToolbox5
{
	...
	public:
		...
		* for more details. */
		...
		/*! @see IWriteValue */
		virtual const IDataValue* getValue() const;
		virtual IDataValue* getValue();
		virtual void setValue(const IDataValue* value);
		virtual void setValue(const DataValue& value);
