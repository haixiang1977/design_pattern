		...
		* to the service call is sent to the client. */
		...
		public:
			...
			* @see Server::BrowseRequest */
			...
			/*! Callback method that is called by the Toolkit whenever a client uses the 'Browse' service
			...
			*		If the toolkit has found any errors (e.g. BadNodeIdUnknown, BadContinuationPointInvalid, ...)
