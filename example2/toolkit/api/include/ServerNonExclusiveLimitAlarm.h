	...
	namespace Server
	{
		...
		* @see NonExclusiveLevelAlarm NonExclusiveDeviationAlarm NonExclusiveRateOfChangeAlarm */
		...
		public:
			...
			/*! @deprecated	Please use NonExclusiveLimitAlarm::create() to construct an instance of this type.
		...
		public:
			...
			*				can be defined by TwoStateVariable::setTrueState() and TwoStateVariable::setFalseState(). */
			DEPRECATED(virtual EnumStatusCode setHighHighState(const ILocalizedText* highHighState));
			/*! @overload */
			DEPRECATED(virtual EnumStatusCode setHighHighState(const ILocalizedText& highHighState));
			...
			*				The localized texts that describe the 'true' and 'false' High state
			*				can be defined by TwoStateVariable::setTrueState() and TwoStateVariable::setFalseState(). */
			DEPRECATED(virtual EnumStatusCode setHighState(const ILocalizedText* highState));
			/*! @overload */
			DEPRECATED(virtual EnumStatusCode setHighState(const ILocalizedText& highState));
			...
			*				The localized texts that describe the 'true' and 'false' Low state
			*				can be defined by TwoStateVariable::setTrueState() and TwoStateVariable::setFalseState(). */
			DEPRECATED(virtual EnumStatusCode setLowState(const ILocalizedText* lowState));
			/*! @overload */
			DEPRECATED(virtual EnumStatusCode setLowState(const ILocalizedText& lowState));
			...
			*				The localized texts that describe the 'true' and 'false' LowLow state
			*				can be defined by TwoStateVariable::setTrueState() and TwoStateVariable::setFalseState(). */
			DEPRECATED(virtual EnumStatusCode setLowLowState(const ILocalizedText* lowLowState));
			/*! @overload */
			DEPRECATED(virtual EnumStatusCode setLowLowState(const ILocalizedText& lowLowState));
