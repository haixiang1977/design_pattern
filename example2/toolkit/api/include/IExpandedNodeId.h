	...
	* namespace table. */
	...
	public:
		...
		* ignored in the server if the namespace URI is specified. */
		...
		/*! @deprecated Please use setNumeric(), setString(), setGuid() or setOpaque() instead. */
		virtual void setIdentifierType(EnumIdentifierType value) = 0;
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IExpandedNodeId& other) = 0;
		/*! @overload */
		virtual bool operator==(const INodeId& other) = 0;
