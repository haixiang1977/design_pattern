	...
	* The static method Guid::generateGuid() may be used to generate a new GUID. */
	...
	public:
		...
		* Example: {00000000-0000-0000-0000-000000000000} */
		...
		/*! @deprecated Please use x.set(y) instead of y.get(x) where x and y are both Guids. */
		virtual void get(IGuid& target) const = 0;
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IGuid& other) = 0;
