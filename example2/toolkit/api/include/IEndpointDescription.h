	...
	* a session with the server. */
	...
	public:
		...
		* Clients may use this URL to connect to the endpoint of the server. */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setServer(const IApplicationDescription* value) = 0;
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setServer(const ApplicationDescription& value) = 0;

		/*! Returns the application instance certificate issued to the server. */
		virtual ByteString getServerCertificate() const = 0;
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setServerCertificate(const ByteString& value) = 0;
		...
		* @see EnumMessageSecurityMode */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setMessageSecurityMode(EnumMessageSecurityMode value) = 0;
		...
		* @li	SecurityPolicyUri_Basic256Sha256 */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setSecurityPolicy(const tstring& value) = 0;
		...
		* @see Client::Session::setUserSecurityPolicy() Client::Session::setUserIdentityToken() */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual EnumStatusCode addUserIdentityToken(const IUserTokenPolicy* value) = 0;

		/*! Returns the URI of the Transport Profile supported by the endpoint.
		* In this version, the Toolkit has only support for the TransportProfileUri_UaTcp_UaSc_UaBinary
		* transport profile.
		*
		* @see TransportProfileUri_UaTcp_UaSc_UaBinary et al. */
		virtual tstring getTransportProfile() const = 0;
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setTransportProfile(const tstring& value) = 0;
		...
		* is not recommended and is only supported for backward compatibility. */
		...
		/*! @deprecated This method will be removed in future versions of this product. */
		virtual void setSecurityLevel(unsigned char value) = 0;
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IEndpointDescription& other) = 0;
