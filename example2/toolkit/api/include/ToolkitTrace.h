...
namespace SoftingOPCToolbox5
{
	...
	* The user application can use the unused bits for custom filter issues. */
	...
	public:
		...
		/*! Writes a line into the Toolkit trace. The line will appear with the given group and level information. */
		...
		*		Within the callback, no calls to the Toolkit are allowed, this may lead
