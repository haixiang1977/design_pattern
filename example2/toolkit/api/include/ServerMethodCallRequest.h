	...
	namespace Server
	{
		...
		* @see MethodCallTransaction */
		...
		public:
			...
			/*! @deprecated Use of this method is deprecated. Please use setInputArgumentResults() instead.
			*
			* Sets the validation results for the input arguments that have been provided by the client. */
			DEPRECATED(EnumStatusCode setInputReturns(const std::vector<EnumStatusCode>& inputReturns));
