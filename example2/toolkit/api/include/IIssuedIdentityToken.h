...
namespace SoftingOPCToolbox5
{
	...
	* Instead, IUserNameIdentityToken and IX509IdentityToken shall be used for that purpose. */
	...
	public:
		...
		*					The encryption algorithm is filled in by the Toolkit and must not
		*					be defined by a client.
		*
		* Sets the URI of the encryption algorithm used for encrypting and decrypting the token data.
		*
		...
		*			it is automatically filled in by the Toolkit (depending on the security policy used),
		...
		* @li Returns >0, if "this > other" */
		...
		virtual bool operator==(const IIssuedIdentityToken& other) = 0;
