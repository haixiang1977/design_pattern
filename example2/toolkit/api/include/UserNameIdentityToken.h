...
namespace SoftingOPCToolbox5
{
	...
	* The password is transported encrypted to avoid a "man in the middle" seeing the password. */
	...
	public:
		...
		virtual bool operator==(const IUserNameIdentityToken& other);
		...
		/* see IUserNameIdentityToken::setEncryptionAlgorithm */
		DEPRECATED(virtual void setEncryptionAlgorithm(const tstring& value));
