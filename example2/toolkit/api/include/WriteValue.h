...
namespace SoftingOPCToolbox5
{
	...
	* to specify a node and its attribute to write. */
	...
	public:
		...
		virtual bool operator==(const IWriteValue& other);
		...
		/* see IWriteValue::getValue */
		DEPRECATED(virtual const IDataValue* getValue() const);
		/*! @overload */
		DEPRECATED(virtual IDataValue* getValue());
		/* see IWriteValue::setValue */
		DEPRECATED(virtual void setValue(const IDataValue* value));
		/*! @overload */
		DEPRECATED(virtual void setValue(const DataValue& value));
