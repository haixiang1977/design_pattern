...
namespace SoftingOPCToolbox5
{
	...
	namespace Server
	{
		...
		* is represented as a data transaction in the Toolkit. Each transaction holds one or more data requests.
		...
		* the Toolkit creates a ReadTransaction that contains a ReadRequest for each node provided with the
		* service call.
		*
